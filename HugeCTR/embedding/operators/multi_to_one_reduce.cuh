...
void multi_to_one_reduce(CopyDesc1 multi_to_one_desc_first_stage,
                         ...
                         cudaStream_t stream) {
  auto partial_grad_ev_ptr = partial_reduce_result.partial_wgrad.template data<float>();
  auto partial_key_ptr = partial_reduce_result.partial_keys.template data<uint32_t>();
  auto partial_ev_length_ptr = partial_reduce_result.partial_ev_length.template data<int32_t>();
  auto partial_dst_offset_array_ptr =
      partial_reduce_result.partial_dst_offset_array.template data<uint32_t>();
  ...
  float* dst_ptr = wgrad.data.template data<float>();
