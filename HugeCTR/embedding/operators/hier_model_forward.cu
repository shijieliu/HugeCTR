  ...
  DISPATCH_INTEGRAL_FUNCTION_CORE23(bucket_range.data_type().type(), offset_t, [&] {
    DISPATCH_FLOAT_AND_HALF_FUNCTION_CORE23(intra_model_comm_buffer.attr.type.type(), emb_t, [&] {
      ...
      CopyDesc multi_to_one_desc{
          ...
          peer_data_ptr,
          intra_model_comm_buffer.attr.id_to_ev_size_in_current_gpu.template data<int>(),
          intra_model_comm_buffer.attr.id_to_ev_start_indices_in_current_gpu.template data<int>(),
          batch_size,
          batch_size_per_rail,
          batch_size_per_node,
          batch_size_per_gpu,
...
void IntraModelForward::dst_reduction(const IntraModelCommBuffer &intra_model_comm_buffer,
  ...
  DISPATCH_FLOAT_AND_HALF_FUNCTION_CORE23(emb_type.type(), emb_t, [&] {
    ...
    CopyDesc multi_to_one_desc{
        ...
        reduction_buffer.attr.indices.network_ids.template data<int>(),
        reduction_buffer.attr.indices.network_gpu_ids.template data<int>(),
        reduction_buffer.attr.indices.network_offsets.template data<int>(),
        ...
        reduction_buffer.attr.id_to_ev_size.template data<int>(),
